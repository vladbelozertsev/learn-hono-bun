...
var auth_js_1 = require("../../libs/mws/auth.js");
var jwt_1 = require("hono/jwt");
var index_js_1 = require("../../libs/helpers/utils/index.js");
var bun_1 = require("bun");
app.get("api/users", auth_js_1.auth, function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var tokenJwt, tokenDecoded, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tokenJwt = c.req.header().authorization.split(" ")[1];
                tokenDecoded = (0, jwt_1.decode)(tokenJwt).payload;
                if (!(tokenDecoded === null || tokenDecoded === void 0 ? void 0 : tokenDecoded.id)) {
                    throw new http_exception_1.HTTPException(401, { message: "Email is empty" });
                }
            ...
            case 1:
                ...
                return [2 /*return*/, c.json({
                        user: (0, index_js_1.delkeys)(user, ["password", "signature"]),
                    })];
        }
    });
}); });
